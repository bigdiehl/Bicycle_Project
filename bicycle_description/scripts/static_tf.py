...
import rospy
import sys 
import tf # because of transformations
import tf2_ros
...
if __name__ == '__main__':
    if len(sys.argv) < 8:
        ...
        if sys.argv[1] == 'world':
            rospy.logerr('Your child_frame_name cannot be "world"')
            sys.exit(0)
        ...
        static_transformStamped.header.frame_id = "world" # Name of parent frame
